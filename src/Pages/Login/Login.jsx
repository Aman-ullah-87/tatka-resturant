...
const Login = () => {
  ...
  return (
    <div
      ...
      className="w-full py-10 px-1 sm:px-5 flex flex-col items-center "
    >
      {" "}
      {/* Container */}
      {/* :LOGIN CONTAINER */}
      <div className="w-full md:w-3/4 max-w-5xl grid grid-cols-2 border border-gray-200 rounded-2xl  text-gray-500 shadow-lg overflow-hidden">
        {/* ::Illustration */}
