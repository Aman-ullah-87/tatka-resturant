...
const Navbar = () => {
  ...
  return (
    <header className="w-full fixed z-10  bg-gray-800 bg-opacity-40  text-gray-100 body-font mb-4 shadow-sm">
      {/* :DESKTOP MENU */}
      <div className="container mx-auto flex justify-between items-center py-7 px-5">
        ...
        >
          ...
          <span className="ml-3 text-xl font-normal flex flex-col text-gray-100 font-semibold antialiased">
            Tatka
            <span className="text-base">Restaurant</span>
          </span>
        </Link>
        {/* Navbar */}
        <nav className="hidden md:ml-auto md:flex flex-wrap items-center justify-center text-base tracking-wide uppercase font-normal">
          {desktopMenu}
        </nav>
        {/* Avatar */}
